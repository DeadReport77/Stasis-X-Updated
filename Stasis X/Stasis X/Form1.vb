...
Public Class Static_X
    ...
    Public Sub CreationEventWatcherPolling()
        ...
        Do
            ...
            If CType(e("TargetInstance"),
                ...
                Process.GetProcessById(CInt(CType(e("TargetInstance"),
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Process.Start("C:\Users\justin.ross\source\repos\Stasis X\Stasis X\Resources\Rane.bat")

    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Process.Start("C:\Users\justin.ross\source\repos\Stasis X\Stasis X\Resources\Radon.bat")
    End Sub

    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Process.Start("C:\Users\justin.ross\source\repos\Stasis X\Stasis X\Resources\Morrayne.bat")
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Process.Start("C:\Users\justin.ross\source\repos\Stasis X\Stasis X\Resources\krom.bat")
    End Sub

    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Process.Start("C:\Users\justin.ross\source\repos\Stasis X\Stasis X\Resources\Cleanse.bat")
    End Sub

    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        Process.Start("C:\Users\justin.ross\source\repos\Stasis X\Stasis X\Resources\Utility.bat")
    End Sub

    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        Process.Start("C:\Users\justin.ross\source\repos\Stasis X\Stasis X\Resources\Network.bat")
    End Sub
